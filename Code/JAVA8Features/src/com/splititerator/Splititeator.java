...
/*it was introduces in java8 present in java.util package. it is use for do parallel
 *  execution on collection objects or arrays and also split them into multiple parts*/
